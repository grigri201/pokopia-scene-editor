...
3. Use `structuredContent.data.summary` as the authoritative summary, including each instance's `footprint`, `effectiveFootprint`, `occupiedCells`, `blockingCells`, `footprintWarnings`, and any derived `stackingRelations`.
