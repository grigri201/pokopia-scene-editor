...
**Epic Impact:** Epic 1-8 已完成并保留为历史。新增能力应作为 Epic 11 追加，不重写 Epic 8 完成记录。Epic 8 的 footprint/occupancy helper 是基础依赖，Epic 11 在其上增加 catalog-driven stacking surface 例外。
...
**PRD Impact:** 需要新增 FR87-FR94、NFR41-NFR44，明确盘子类 food surface、地毯/底垫/嫩芽/低高度素材的局部叠放规则，以及 `SceneDocument v1` 保持不变。
...
- 新增 FR87-FR94，覆盖 catalog metadata、盘子承载食物、底垫/地毯/嫩芽/低高度素材同层兼容 overlap、derived stacking relation、UI/export/Worker/MCP parity。
- 新增 NFR41-NFR44，覆盖 deterministic helper、测试矩阵、错误结构和 v1 schema 边界。
